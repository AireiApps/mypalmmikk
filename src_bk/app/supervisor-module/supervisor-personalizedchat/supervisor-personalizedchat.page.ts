...
@Component({
  selector: "app-supervisor-personalizedchat",
  templateUrl: "./supervisor-personalizedchat.page.html",
  styleUrls: ["./supervisor-personalizedchat.page.scss"],
})
export class SupervisorPersonalizedchatPage implements OnInit {
  personalizedForm;
  ...
  btn_save() {
    ...
    //this.imagePaths.video_path = "http://103.27.72.29/mms.airei.com.my1/java/generic_upload/1001-genericpersonalizedcommunication5772-1613110295595.mp4";
  ...
  gotoback() {
    this.router.navigate(["/boiler-personalizedchatdepartment"]);
  }
}
