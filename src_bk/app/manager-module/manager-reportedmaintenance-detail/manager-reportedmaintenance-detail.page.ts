...
@Component({
  selector: "app-manager-reportedmaintenance-detail",
  templateUrl: "./manager-reportedmaintenance-detail.page.html",
  styleUrls: ["./manager-reportedmaintenance-detail.page.scss"],
})
export class ManagerReportedmaintenanceDetailPage implements OnInit {
