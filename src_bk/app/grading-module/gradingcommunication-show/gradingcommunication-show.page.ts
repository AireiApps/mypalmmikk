...
@Component({
  selector: 'app-gradingcommunication-show',
  templateUrl: './gradingcommunication-show.page.html',
  styleUrls: ['./gradingcommunication-show.page.scss'],
})
export class GradingcommunicationShowPage implements OnInit {
