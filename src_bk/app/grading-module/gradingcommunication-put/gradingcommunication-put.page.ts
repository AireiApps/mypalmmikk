...
@Component({
  selector: "app-gradingcommunication-put",
  templateUrl: "./gradingcommunication-put.page.html",
  styleUrls: ["./gradingcommunication-put.page.scss"],
})
export class GradingcommunicationPutPage implements OnInit {
