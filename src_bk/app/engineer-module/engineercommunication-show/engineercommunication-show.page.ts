...
@Component({
  selector: 'app-enginnercommunication-show',
  templateUrl: './engineercommunication-show.page.html',
  styleUrls: ['./engineercommunication-show.page.scss'],
})
export class EngineercommunicationShowPage implements OnInit {
