...
@Component({
  selector: "app-engineer-breakdown-new",
  templateUrl: "./engineer-breakdown-new.page.html",
  styleUrls: ["./engineer-breakdown-new.page.scss"],
})
export class EngineerBreakdownNewPage implements OnInit {
    ...
    if (this.newbreakdowndowntimeForm.valid) {
      ...
      this.service.savebreakdowndowntime(req).then((result) => {
        ...
        if (resultdata.httpcode == 200) {
          ...
          this.router.navigate(["/engineer-breakdown-list"]);
