...
@Component({
  selector: "app-enginnercommunication",
  templateUrl: "./engineercommunication.page.html",
  styleUrls: ["./engineercommunication.page.scss"],
})
export class EngineercommunicationPage implements OnInit {
