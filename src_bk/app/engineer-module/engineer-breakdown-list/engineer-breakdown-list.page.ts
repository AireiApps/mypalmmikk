...
@Component({
  selector: 'app-engineer-breakdown-list',
  templateUrl: './engineer-breakdown-list.page.html',
  styleUrls: ['./engineer-breakdown-list.page.scss'],
})
export class EngineerBreakdownListPage implements OnInit {
  ...
  {
    this.router.navigate(["/engineer-breakdown-new"]);
  }
}
