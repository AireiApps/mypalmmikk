...
@Component({
  selector: 'app-personalizecommunicationreport',
  templateUrl: './personalizecommunicationreport.page.html',
  styleUrls: ['./personalizecommunicationreport.page.scss'],
})
export class PersonalizecommunicationreportPage implements OnInit {
