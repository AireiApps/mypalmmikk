...
@Component({
  selector: 'app-personalizedcommunicationreport',
  templateUrl: './personalizedcommunicationreport.page.html',
  styleUrls: ['./personalizedcommunicationreport.page.scss'],
})
export class PersonalizedcommunicationreportPage implements OnInit {
