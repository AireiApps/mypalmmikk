...
@Component({
  selector: "app-boiler-reportedmaintenance-new",
  templateUrl: "./boiler-reportedmaintenance-new.page.html",
  styleUrls: ["./boiler-reportedmaintenance-new.page.scss"],
})
export class BoilerReportedmaintenanceNewPage implements OnInit {
    ...
    if (this.newbreakdowndowntimeForm.valid) {
      ...
      this.service.savebreakdowndowntime(req).then((result) => {
        ...
        if (resultdata.httpcode == 200) {
          ...
          this.router.navigate(["/boiler-reportedmaintenance-list"]);
