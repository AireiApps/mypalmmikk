...
@Component({
  selector: "app-laboratory-personalizedchat",
  templateUrl: "./laboratory-personalizedchat.page.html",
  styleUrls: ["./laboratory-personalizedchat.page.scss"],
})
export class LaboratoryPersonalizedchatPage implements OnInit {
