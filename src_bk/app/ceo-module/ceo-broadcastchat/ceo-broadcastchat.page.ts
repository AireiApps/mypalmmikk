...
@Component({
  selector: "app-ceo-broadcastchat",
  templateUrl: "./ceo-broadcastchat.page.html",
  styleUrls: ["./ceo-broadcastchat.page.scss"],
})
export class CeoBroadcastchatPage implements OnInit {
  broadcastForm;
