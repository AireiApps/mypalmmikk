...
@Component({
  selector: 'app-ceosupervisormillcomments',
  templateUrl: './ceosupervisormillcomments.page.html',
  styleUrls: ['./ceosupervisormillcomments.page.scss'],
})
export class CeosupervisormillcommentsPage implements OnInit {
  ...
  btn_save()
  {
    ...
    this.service.saveMaintenanceComments(req).then((result) => {
      ...
      if (resultdata.httpcode == 200) {
        ...
        this.router.navigate(["/supervisormillreport"]);
