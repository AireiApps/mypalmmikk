...
@Component({
  selector: "app-grading-chat",
  templateUrl: "./grading-chat.page.html",
  styleUrls: ["./grading-chat.page.scss"],
})
export class GradingChatPage implements OnInit {
  broadcastForm;
  ...
  /*messageArr = [
    {
      ...
      createdAt: "20-01-2021 11:00:00",
      image: "",
    },
    {
      user: "Joswa",
      message: "Hai Good Morning",
      createdAt: "20-01-2021 12:00:00",
      image:
        "http://103.27.72.29/mms.airei.com.my1/java/generic_upload/1001-genericffb5339-1611134541702.jpg",
    },
    {
      user: "Suresh",
      message: "Hai Good Morning",
      createdAt: "20-01-2021 01:00:00",
      image:
        "http://103.27.72.29/mms.airei.com.my1/java/generic_upload/1001-genericffb5339-1611134541702.jpg",
    },
    {
