...
@Component({
  selector: "app-security-broadcastchat",
  templateUrl: "./security-broadcastchat.page.html",
  styleUrls: ["./security-broadcastchat.page.scss"],
})
export class SecurityBroadcastchatPage implements OnInit {
