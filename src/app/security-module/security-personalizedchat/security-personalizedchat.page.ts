...
@Component({
  selector: "app-security-personalizedchat",
  templateUrl: "./security-personalizedchat.page.html",
  styleUrls: ["./security-personalizedchat.page.scss"],
})
export class SecurityPersonalizedchatPage implements OnInit {
  ...
  gotoback() {
    this.router.navigate(["/security-personalizedchatdepartment"]);
  }
}
