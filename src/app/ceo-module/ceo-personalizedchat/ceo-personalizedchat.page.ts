...
@Component({
  selector: "app-ceo-personalizedchat",
  templateUrl: "./ceo-personalizedchat.page.html",
  styleUrls: ["./ceo-personalizedchat.page.scss"],
})
export class CeoPersonalizedchatPage implements OnInit {
  personalizedForm;
