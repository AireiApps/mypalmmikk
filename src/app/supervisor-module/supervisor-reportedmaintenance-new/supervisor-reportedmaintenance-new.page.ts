...
@Component({
  selector: 'app-supervisor-reportedmaintenance-new',
  templateUrl: './supervisor-reportedmaintenance-new.page.html',
  styleUrls: ['./supervisor-reportedmaintenance-new.page.scss'],
})
export class SupervisorReportedmaintenanceNewPage implements OnInit {
    ...
    if (this.newbreakdowndowntimeForm.valid) {
      ...
      this.service.savebreakdowndowntime(req).then((result) => {
        ...
        if (resultdata.httpcode == 200) {
          ...
          this.router.navigate(["/supervisor-reportedmaintenance-list"]);
