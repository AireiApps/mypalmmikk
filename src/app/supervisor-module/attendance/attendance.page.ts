...
export class AttendancePage implements OnInit {
  ...
  headerArr = [
    {
      station_name: "VS station",
      empArr: this.usersArr,
    },
    {
      station_name: "Ramp station",
      empArr: this.usersArr,
    },
    {
      station_name: "Press station",
      empArr: this.usersArr,
    },
  ];
  ...
  /*getRemarks()
  {
    this.service.getRemarks().then(result => {
      let resultdata: any;
      resultdata = result;      
      if (resultdata.httpcode == 200) {
        this.remarksArr = resultdata.data;        
      }
    });
  }*/
  ...
  stationBuild() {
    ...
    //   this.addEmployee(i, this.headerArr[i].empArr);
    // }
  }
  ...
  //     txt_restday: new FormControl(value.txt_restday),
  //     txt_publicholiday: new FormControl(value.txt_publicholiday),
  //     remarks: new FormControl(value.txt_publicholiday),
  //   });
  // }

  // initHeaderRow(eachheader) {
  //   // var dummyArr = [];
  //   // for (var i = 0; i < eachheader.innerArr.length; i++) {
  //   //   dummyArr.push(this.initItemRows(eachheader.innerArr[i]));
  //   // }
  //   return this.fb.group({
  //     station_name: new FormControl(eachheader.station_name),
  //     innerArr: this.fb.array([eachheader.innerArr]),
  //   });
  // }

  // addNewRow() {
  //   for (var i = 0; i < this.headerArr.length; i++) {
  //     this.formArr.push(this.initHeaderRow(this.headerArr[i]));
  //   }

  //   const arrayval = <FormArray>this.attendanceform.controls.itemRows;
  ...
  // employees(): FormArray {
  //   return this.attendanceform.get("itemRows") as FormArray;
  // }

  // getItemRowEmp(empIndex: number): FormArray {
  //   return this.employees().at(empIndex).get("innerArr") as FormArray;
  // }

  // getformVal() {
  //   return <FormArray>this.attendanceform.controls.itemRows;
  // }
