...
@Component({
  selector: "app-laboratory-broadcastchat",
  templateUrl: "./laboratory-broadcastchat.page.html",
  styleUrls: ["./laboratory-broadcastchat.page.scss"],
})
export class LaboratoryBroadcastchatPage implements OnInit {
