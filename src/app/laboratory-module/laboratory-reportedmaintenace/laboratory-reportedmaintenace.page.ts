...
@Component({
  selector: "app-laboratory-reportedmaintenace",
  templateUrl: "./laboratory-reportedmaintenace.page.html",
  styleUrls: ["./laboratory-reportedmaintenace.page.scss"],
})
export class LaboratoryReportedmaintenacePage implements OnInit {
    ...
    if (this.newbreakdowndowntimeForm.valid) {
      ...
      this.service.savebreakdowndowntime(req).then((result) => {
        ...
        if (resultdata.httpcode == 200) {
          ...
          this.router.navigate(["/laboratory-reportedmaintenace-list"]);
