...
@Component({
  selector: 'app-storecommunication-put',
  templateUrl: './storecommunication-put.page.html',
  styleUrls: ['./storecommunication-put.page.scss'],
})
export class StorecommunicationPutPage implements OnInit {
      ...
      if (this.personalizedcommunicationForm.valid) 
      {
        ...
        this.service.savePersonalizedCommunication(areq).then((result) => {
          ...
          if (resultdata.httpcode == 200) {
            ...
            this.router.navigate(["/personalizecommunicationreport"]);
          } else {
            this.commonservice.presentToast("Saved Failed!");
          }        
        });
