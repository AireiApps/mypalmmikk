...
@Component({
  selector: 'app-storecommunication-show',
  templateUrl: './storecommunication-show.page.html',
  styleUrls: ['./storecommunication-show.page.scss'],
})
export class StorecommunicationShowPage implements OnInit {
