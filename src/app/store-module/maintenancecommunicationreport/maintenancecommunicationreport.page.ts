...
@Component({
  selector: 'app-maintenancecommunicationreport',
  templateUrl: './maintenancecommunicationreport.page.html',
  styleUrls: ['./maintenancecommunicationreport.page.scss'],
})
export class MaintenancecommunicationreportPage implements OnInit {
