...
@Component({
  selector: 'app-manager-breakdown-list',
  templateUrl: './manager-breakdown-list.page.html',
  styleUrls: ['./manager-breakdown-list.page.scss'],
})
export class ManagerBreakdownListPage implements OnInit {
  ...
  {
    this.router.navigate(["/manager-breakdown-new"]);
  }
