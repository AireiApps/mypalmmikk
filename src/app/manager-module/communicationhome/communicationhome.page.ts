...
@Component({
  selector: "app-communicationhome",
  templateUrl: "./communicationhome.page.html",
  styleUrls: ["./communicationhome.page.scss"],
})
export class CommunicationhomePage implements OnInit {
