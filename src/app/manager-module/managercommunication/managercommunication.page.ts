...
@Component({
  selector: "app-managercommunication",
  templateUrl: "./managercommunication.page.html",
  styleUrls: ["./managercommunication.page.scss"],
})
export class ManagercommunicationPage implements OnInit {
