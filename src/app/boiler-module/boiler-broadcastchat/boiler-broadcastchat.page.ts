...
@Component({
  selector: "app-boiler-broadcastchat",
  templateUrl: "./boiler-broadcastchat.page.html",
  styleUrls: ["./boiler-broadcastchat.page.scss"],
})
export class BoilerBroadcastchatPage implements OnInit {
  broadcastForm;
  ...
  ngAfterViewInit(): void {
    this.callAPI();
    //this.progressInterval = setInterval(() => { this.callAPI(); }, 10000);
  }
