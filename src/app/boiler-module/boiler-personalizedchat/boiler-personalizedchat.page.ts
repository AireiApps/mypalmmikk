...
@Component({
  selector: "app-boiler-personalizedchat",
  templateUrl: "./boiler-personalizedchat.page.html",
  styleUrls: ["./boiler-personalizedchat.page.scss"],
})
export class BoilerPersonalizedchatPage implements OnInit {
