...
@Component({
  selector: "app-boiler-breakdown-new",
  templateUrl: "./boiler-breakdown-new.page.html",
  styleUrls: ["./boiler-breakdown-new.page.scss"],
})
export class BoilerBreakdownNewPage implements OnInit {
    ...
    if (this.newbreakdowndowntimeForm.valid) {
      ...
      this.service.savebreakdowndowntime(req).then((result) => {
        ...
        if (resultdata.httpcode == 200) {
          ...
          this.router.navigate(["/boiler-breakdown-list"]);
